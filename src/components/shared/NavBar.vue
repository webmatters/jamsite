<template>
  ...
  >
    ...
    <div
      ...
      class="px-2 pt-2 pb-4 sm:flex text-primary flex items-center"
    >
      <g-link
        class="block px-2 py-1 font-semibold rounded hover:text-secondary"
        to="/services/"
        >Services</g-link
      >
      <g-link
        class="block mt-1 px-2 py-1 font-semibold rounded hover:text-secondary sm:mt-0 sm:ml-6"
        to="/about/"
        >About</g-link
      >
      <g-link
      ...
      >
      <g-link
        class="block mt-1 px-4 py-2 font-semibold rounded-full bg-cta text-white hover:bg-cta-hover sm:mt-0 sm:ml-6"
        to="/contact/"
